...
public class SettingItemView extends LinearLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta =
                attrs == null
                        ? null
                        : getContext().obtainStyledAttributes(attrs, io.rong.imkit.R.styleable.SettingItemView);
        if (ta != null) {
            final int N = ta.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = ta.getIndex(i);
                switch (attr) {
                    case io.rong.imkit.R.styleable.SettingItemView_item_image:
                        Drawable drawable = ta.getDrawable(attr);
                        ivImage.setVisibility(VISIBLE);
                        ivImage.setImageDrawable(drawable);
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_image_height:
                        ...
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_image_width:
                        ...
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_content:
                        String content = ta.getString(attr);
                        tvContent.setText(content == null ? "" : content);
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_content_text_size:
                        ...
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_content_text_color:
                        int color = ta.getColor(attr, -1);
                        if (color > 0) {
                            tvContent.setTextColor(color);
                        }
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_value:
                        String value = ta.getString(attr);
                        tvValue.setVisibility(VISIBLE);
                        tvValue.setText(value);
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_value_text_size:
                        float valueSize = ta.getDimension(attr, 0);
                        if (valueSize > 0) {
                            tvValue.setTextSize(TypedValue.COMPLEX_UNIT_PX, Math.round(valueSize));
                        }
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_value_text_color:
                    ...
                    case io.rong.imkit.R.styleable.SettingItemView_item_tag_image:
                        Drawable tagImage =
                                ta.getDrawable(io.rong.imkit.R.styleable.SettingItemView_item_tag_image);
                        if (tagImage != null) {
                            ivTagImage.setImageDrawable(tagImage);
                        }
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_tag_image_height:
                        float tagImageHeight =
                                ta.getDimension(
                                        io.rong.imkit.R.styleable.SettingItemView_item_tag_image_height, 0);
                        if (tagImageHeight > 0) {
                        ...
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_tag_image_width:
                        float tagImageWidth =
                                ta.getDimension(
                                        io.rong.imkit.R.styleable.SettingItemView_item_tag_image_width, 0);
                        if (tagImageWidth > 0) {
                        ...
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_divider:
                        boolean divider = ta.getBoolean(attr, false);
                        vDivider.setVisibility(divider ? VISIBLE : GONE);
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_switch:
                        ...
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_null_background:
                        Boolean bgNull = ta.getBoolean(attr, false);
                        if (bgNull) {
                            setBackground(null);
                        }
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_background:
                        Drawable bg = ta.getDrawable(attr);
                        setBackground(bg);
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_show_selected:
                        isShowSelected = ta.getBoolean(attr, false);
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_selected_image:
                        Drawable selectedImage = ta.getDrawable(attr);
                        ivSelectImage.setImageDrawable(selectedImage);
                        break;
                    case io.rong.imkit.R.styleable.SettingItemView_item_right_image:
                        ...
                        break;
//                    case io.rong.imkit.R.styleable.SettingItemView_item_right_image_height:
...
//                        }
//                        break;
//                    case io.rong.imkit.R.styleable.SettingItemView_item_right_image_width:
